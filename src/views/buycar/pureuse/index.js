                  ...
                  {val.list.map((itemval, itemindex) => {
                    return (
                      <li key={'item-item-' + itemindex}>
                        ...
                        <div className="l">
                          <h3 onClick={(e) => this.showGoodsModal(e, itemval)}>{itemval.name}</h3>
                          {/* <h3 onClick={(e) => this.showGoodsModal(e, itemval)}>{itemval.name.split('  ')[0]}<br />{itemval.name.split('  ')[1]}</h3> */}
                          <div className="price">
          ...
          >
            <div className="my-modal-big">
              ...
              {this.state.goodsDetail.thumb && <div className="my-modal-box">
                ...
                <div className="carName">适用车型：<sapn className="cCont">{this.state.goodsDetail.carName}</sapn></div>
